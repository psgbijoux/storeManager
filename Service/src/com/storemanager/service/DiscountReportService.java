...
import com.storemanager.util.reports.DiscountReportGenerator;
...
@Service
public class DiscountReportService implements StoreService {
    private ReportDAO dao;

    @Autowired
    public DiscountReportService(ReportDAOImpl dao) {
        this.dao = dao;
    }

    public void generateDiscountSaleReport(Date startDate, Date endDate) throws ServiceException {
        ...
        try {
            DiscountReportGenerator.create(path + "\\" + fileName, reportName, data);
